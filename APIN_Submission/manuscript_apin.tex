...
\begin{figure*}[t]
\centering
\includegraphics[width=0.98\textwidth]{fig2_updated_premium.pdf}
\caption{Comprehensive pruning performance analysis across architectures and datasets. Rows 1-2: Accuracy vs. pruning ratio curves for ResNet-20/56/110 and VGG-16 on CIFAR-10/100. Row 3: (i) GRA advantage heatmap across configurations, (j) VGG-16 detailed comparison showing consistent GRA superiority, (k) Cross-architecture advantage summary at 50\% pruning (mean $+1.18\%$), and (l) Tiny-ImageNet-200 results demonstrating GRA's strongest advantage ($+2.4\%$ at 50\% pruning). \textbf{Error bars indicate standard deviation across multiple runs.}}
